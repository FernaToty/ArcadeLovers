...
bool ModuleParticles::Start()
{
	...
	//Auto powerup Shoot
	AutoShoot.anim.PushBack({ 261, 420, 25, 26 });
	AutoShoot.speed.y -= 5;
	AutoShoot.lifetime = 180;
	AutoShoot.anim.speed = 0.2f;

	//Auto power up anim
	Auto.anim.PushBack({ 270, 481, 31, 32 });
	Auto.anim.PushBack({ 299, 481, 30, 33 });
	Auto.anim.PushBack({ 328, 481, 30, 33 });
	Auto.anim.PushBack({ 356, 481, 30, 33 });
	Auto.anim.loop = true;
	Auto.anim.speed = 0.1f;
